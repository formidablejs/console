...
const $applicationEvents$ = Symbol.for('#applicationEvents'), $onDefaultCommandEvents$ = Symbol.for('#onDefaultCommandEvents'), $__init__$ = Symbol.for('#__init__'), $__patch__$ = Symbol.for('#__patch__'), $__initor__$ = Symbol.for('#__initor__'), $__inited__$ = Symbol.for('#__inited__'), $__hooks__$ = Symbol.for('#__hooks__'), $silentExit$ = Symbol.for('#silentExit');
...
class Application {
	...
	*/
	async run(signature = null){
		...
		await command.run(options,(results instanceof $5.default) ? results : undefined);
