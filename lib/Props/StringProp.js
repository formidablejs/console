...
class StringProp extends $1.default {
	static [$__init__$](){
	...
	[$__patch__$]($$ = {}){
		...
		($3 = $$.allowsMany) !== undefined && (this.allowsMany = $3);
	...
	[$__init__$]($$ = null,deep = true){
		...
		this.allowsMany = ($$ && ($4 = $$.allowsMany) !== undefined) ? ($4) : false;
...
exports.default = StringProp; StringProp[$__init__$]();
