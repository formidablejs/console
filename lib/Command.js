...
const $_globalOptions$ = Symbol.for('#_globalOptions'), $silentExit$ = Symbol.for('#silentExit'), $__init__$ = Symbol.for('#__init__'), $__patch__$ = Symbol.for('#__patch__'), $__initor__$ = Symbol.for('#__initor__'), $__inited__$ = Symbol.for('#__inited__'), $__hooks__$ = Symbol.for('#__hooks__');
...
class Command {
	[$__patch__$]($$ = {}){
		...
		($3 = $$[$silentExit$]) !== undefined && (this[$silentExit$] = $3);
	...
	[$__init__$]($$ = null,deep = true){
		...
		this[$silentExit$] = ($$ && ($4 = $$[$silentExit$]) !== undefined) ? ($4) : false;
	...
	*/
	async run(options,globalOptions){
	...
	*/
	exit(exitCode = null){
		...
		if (!this[$silentExit$]) {
			...
			return process.exit((($5 = process.exitCode) != null) ? ($5) : 0);
		};
	}
};
